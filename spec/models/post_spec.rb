...
RSpec.describe Post, type: :model do
  ...
  it "is valid with valid attributes" do
    expect(Post.new(title: 'first post', short_description: 'Short desc.', user_id: admin.id)).to be_valid
  end
  ...
  it "adds random number to duplicate slug" do
    first_post = Post.create(title: 'first post', short_description: 'Short desc.', user_id: admin.id)
    first_post.update(title: 'first')
    second_post = Post.create(title: 'first post', short_description: 'Short desc.', user_id: admin.id)
